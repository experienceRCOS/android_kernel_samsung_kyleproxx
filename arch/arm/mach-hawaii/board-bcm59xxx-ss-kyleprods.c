...
#endif
#ifdef CONFIG_MACH_HAWAII_SS_KYLEPRODS
	/* MBC_TURBO disable */
	{.addr =  PMU_REG_OTG_BOOSTCTRL3, .val = 0x00, .mask = 0x10},
#endif
	/* MMSR LPM voltage - 0.88V */
	{.addr = PMU_REG_MMSRVOUT2 , .val = 0x4, .mask = 0x3F},
	/* SDSR1 NM1 voltage - 1.30V */
	{.addr = PMU_REG_SDSR1VOUT1 , .val = 0x2E, .mask = 0x3F},     // Set to 1.30V for super turbo mode.
...
static struct batt_volt_cap_map ss_kyleprods_volt_cap_lut[] = {
	{4321, 100},
	{4250, 95},
	{4183, 90},
	{4126, 85},
...
static struct batt_eoc_curr_cap_map ss_kyleprods_eoc_cap_lut[] = {
	 {290, 90},
	 {270, 91},
	 {250, 92},
	 {228, 93},
...
static struct batt_cutoff_cap_map ss_kyleprods_cutoff_cap_lut[] = {
	{3480, 2},
	{3440, 1},
	{3400, 0},
};
...
static struct batt_esr_temp_lut ss_kyleprods_esr_temp_lut[] = {
	{
		.temp = -200,
...
/* SS B100BE profile */
static struct bcmpmu_batt_property ss_kyleprods_props = {
	.model = "SS B100BE",
	.min_volt = 3400,
	.max_volt = 4350,
	.full_cap = 1500 * 3600,
	.one_c_rate = 1500,
	.volt_cap_lut = ss_kyleprods_volt_cap_lut,
	.volt_cap_lut_sz = ARRAY_SIZE(ss_kyleprods_volt_cap_lut),
	.esr_temp_lut = ss_kyleprods_esr_temp_lut,
	.esr_temp_lut_sz = ARRAY_SIZE(ss_kyleprods_esr_temp_lut),
	.eoc_cap_lut = ss_kyleprods_eoc_cap_lut,
	.eoc_cap_lut_sz = ARRAY_SIZE(ss_kyleprods_eoc_cap_lut),
	.cutoff_cap_lut = ss_kyleprods_cutoff_cap_lut,
	.cutoff_cap_lut_sz = ARRAY_SIZE(ss_kyleprods_cutoff_cap_lut),
};

static struct bcmpmu_batt_cap_levels ss_kyleprods_cap_levels = {
	.critical = 5,
	.low = 15,
	.normal = 75,
	.high = 95,
...
/* SS B100BE profile */
static struct bcmpmu_batt_volt_levels ss_kyleprods_volt_levels = {
	.critical = 3400,
	.low = 3500,
	.normal = 3700,
	.high   = 4300,
...
static struct bcmpmu_batt_cal_data ss_kyleprods_cal_data = {
	.volt_low = 3550,
	.cap_low = 5,  /* lower entering low calibration */
};

static struct bcmpmu_fg_pdata fg_pdata = {
	.batt_prop = &ss_kyleprods_props,
	.cap_levels = &ss_kyleprods_cap_levels,
	.volt_levels = &ss_kyleprods_volt_levels,
	.cal_data = &ss_kyleprods_cal_data,
	.sns_resist = 10,
	.sys_impedence = 33,
